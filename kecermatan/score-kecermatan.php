...
$sql = "SELECT * FROM kecermatan ORDER BY id DESC LIMIT 1";
...
<head>
    ...
    <link rel="icon" href="/web ujian/polri.png" type="image/png" />
...
<body>
    <div class="container">
        ...
        <a href="/web ujian/index.html" class="button">Kembali</a>
    </div>
</body>
</html>
